...
enum TokenType {
  ...
  IF, ELSE, FOR, WHILE, FN, RETURN, TYPE_BOOL, TYPE_FLOAT, TYPE_INT, TYPE_CHAR, VAR, //keywords
...
//given a single character string, it checks if it is a singular punctuation
